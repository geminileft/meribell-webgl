...
const SHADER_COLOR_3D_LINES_VERTEX_SHADER = `
...
const SHADER_COLOR_3D_LINES_FRAGMENT_SHADER = `
precision mediump float;
...
function shader_color_3d_lines_draw(gl, draw_data) {
  ...
  gl.drawArrays(gl.LINES, 0, draw_ct);
...
const shader_color_3d_lines_shader = {
  name: 'shader_color_3d_lines'
  , vs: SHADER_COLOR_3D_LINES_VERTEX_SHADER
  , fs: SHADER_COLOR_3D_LINES_FRAGMENT_SHADER
  ...
  , draw: shader_color_3d_lines_draw
};

shader_programs.push(shader_color_3d_lines_shader);
