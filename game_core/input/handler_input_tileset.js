function Handler_Input_Tileset(gfx, hr, map_height) {
    this.actions = {dir:[], ui:[]};
    this.hr = hr;
    this.gfx = gfx;
...
Handler_Input_Tileset.prototype.update = function(actions) {
...
Handler_Input_Tileset.prototype.processActions = function(current_actions, actions) {
    ...
    const keyActionFunc = function(key_val) {
        ...
        switch (key_val) {
            ...
            break;
            case 's': action = ACTION_DOWN;
            break;
            case 'w': action = ACTION_UP;
            break;
        }
        return action;
    }
